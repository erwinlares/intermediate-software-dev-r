...
Place an **M** for mandatory and an **O** for optional in front of the statements:

```output
    ___ Installing the roxygen2 package
    ___ Add comments within functions 
    ___ Write documentation for help when typing ?function_name in the console.
    ___ Write a vignette to show examples
    ___ Write multiple vignettes
    ___ Updating the documentation as new functions are added  
```
